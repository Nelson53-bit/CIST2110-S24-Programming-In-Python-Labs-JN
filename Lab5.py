...
def string_counter(str: str):
    """takes in a string and returns the number of letters in a string
...
def string_repeater(str: str, num: int):
    """takes in a string and returns a longer string with the original sring repeated multiple times
...
def jacket_checker(temp: int, raining: bool)-> str:
    """jacket_checker will take in a int and a bool and return whether you should wear a jacket or not
...
def user_jacket_checker() -> str:
    """asks the user for a temperature and whether it is raining and then calls jacket_checker function to tell the user whether they should wear a jacket or not

    Returns:
    str: "Wear a Jacket" or "Do not wear Jacket" 
    """
